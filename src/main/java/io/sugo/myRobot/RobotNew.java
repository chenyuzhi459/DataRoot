...
public class RobotNew {
    ...
    public static Map<Integer,Map<String,Object>> oldUsers = new HashMap<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        DateTime startTime = nowTime.minusDays(Integer.valueOf(props.getProperty("numOfDayBefore","0")));
        //执行时间
        ...
        while (present.isBefore(endTime)) {
            ...
            if(present.isBefore(nowTime)) {
                ...
                String info = "user number : "+ num + "  , " + "send message count : "+sended;
                logger.info(info);
//                System.out.println(info);
            ...
            //判断是生成新用户，还是从老用户中取
            //老用户
            boolean isOldUser = random.nextInt(100) > 35 && num >300 ;
