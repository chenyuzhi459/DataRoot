...
import io.sugo.cache.SessionCache;
import io.sugo.common.IpInfo;
...
public class ActionUtil {
  ...
  static int maxUserId = 20000000;

  public static String getAction(int userCount, int pos, int totalRows) throws Exception {
    ...
    userCount = userCount + (100 - pos / (totalRows / 100)) * (50000 + rand.nextInt(100000));
    if (userCount > maxUserId) {
      userCount = maxUserId - rand.nextInt(200000);
    }
    if(userCount < 1){
      userCount = rand.nextInt(200000);
    }

    String userId = getDeviceId(userCount);
    ...
    DateTime dateTime = new DateTime().plusDays(-1 * pos / (totalRows / 100)).plusSeconds(-1 * rand.nextInt(86400));
    sb.append("EventDateTime=" + dateTime.getMillis()).append("&");
  ...
  public static String getDeviceId(int userCount) throws NoSuchAlgorithmException {
    MessageDigest md = MessageDigest.getInstance("MD5");
    md.update(String.valueOf(rdint.nextInt(userCount)).getBytes());
