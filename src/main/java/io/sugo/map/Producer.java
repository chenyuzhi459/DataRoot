...
public class Producer implements Runnable {
   ...
   */
  private static char columnSplit = (char) 1;

  private String getAction(DateTime dt) {
    StringBuilder header = new StringBuilder("s|id,d|ts,i|ele,f|vol,s|nation,s|brand,s|model,s|version,s|action,s|label");
    StringBuilder data = new StringBuilder();
    data.append(String.format("ID-%07d", rand.nextInt(100000)) + columnSplit);
    data.append(dt.getMillis() + "" + columnSplit);
    data.append(rand.nextInt(200) + "" + columnSplit);
    data.append(String.format("%.2f", rand.nextFloat() + rand.nextInt(100)) + columnSplit);
    data.append(nations[rand.nextInt(nations.length)] + columnSplit);
    data.append(deviceBrand[rand.nextInt(deviceBrand.length)] + columnSplit);
    data.append(deviceModel[rand.nextInt(deviceModel.length)] + columnSplit);
    data.append(sysVersions[rand.nextInt(sysVersions.length)] + columnSplit);
    data.append(eventAction[rand.nextInt(eventAction.length)] + columnSplit);
    data.append(eventLabel[rand.nextInt(eventLabel.length)]);

    int keySize = rand.nextInt(18) + 3;
    for (int i = 0; i < keySize; i++) {
      header.append(",s|KEY" + rand.nextInt(200000));
      data.append(columnSplit);
      data.append(rand.nextInt(2000000) + 100);
    }
  ...
  public static void main(String[] args) {
    ...
    String action = p.getAction(new DateTime());
