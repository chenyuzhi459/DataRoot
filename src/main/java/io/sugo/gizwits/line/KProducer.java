package io.sugo.gizwits.line;

import io.sugo.gizwits.ProducerCallback;
...
public class KProducer implements Runnable {
  ...
  public KProducer(Properties props,
    ...
    startTime = new DateTime(startStr).withTimeAtStartOfDay();
    String endStr = props.getProperty("endTime", "2015-01-01T00:02:00.000+08:00");
    endTime = new DateTime(endStr).plusDays(1).withTimeAtStartOfDay().minusMillis(1);
